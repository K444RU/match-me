    ...
    <div className="h-screen w-full bg-background-900 p-8">
        ...
        <CardContent>
          <div className="grid w-full items-center gap-4">
            <div className="flex flex-col space-y-1.5">
              <Button onClick={bulkCreateUsers}>Create 100 Users</Button>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="w-[350px] bg-white">
        <CardHeader>
          ...
          <CardDescription>Paste the array of emails to delete users from the system.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid w-full items-center gap-4">
            <div className="flex flex-col space-y-1.5">
              ...
              />
              <Button onClick={bulkDeleteUsers} variant="destructive" disabled={!emailsInput.trim()}>
                Delete Users
              </Button>
            </div>
          </div>
