...
public class ConnectionService {
    ...
    /**
     * Gets all connections for a user, splitting them into active, pending incoming, and pending outgoing lists.
     *
     * This method fetches all connections for the given user and organizes them based on their current state:
     ...
     *
     * Only the target of the request can accept it, and it must be in a pending state.
     *
     ...
     *
     * Only the target of the request can reject it, and it must be in a pending state.
     *
     ...
     *
     * Any user in the connection can disconnect it, but it must be in an accepted state.
     *
    ...
    /**
     * Helper method that creates a new connection with a pending state between two users.
     *
     * @param requesterId The ID of the user sending the request.
     * @param targetId The ID of the user receiving the request.
     */
    ...
    /**
     * Helper method that adds a new state to an existing connection (e.g., ACCEPTED, REJECTED).
     *
     * @param connection The connection to update.
     * @param status The new status to set (e.g., ACCEPTED, REJECTED).
     * @param requesterId The ID of the original requester (can be null for DISCONNECTED).
     * @param targetId The ID of the original target (can be null for DISCONNECTED).
    ...
    /**
     * Helper method that finds the latest state (accepted or pending) for a connection.
     *
